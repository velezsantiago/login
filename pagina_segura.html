...
<!-- <h2> <?php echo "<h4> usuario/a ".$_SESSION['usuario']. "</h4";

error_reporting(0)?> </h2> -->
...
<header>
    ...
    <nav class="navegacion">
        <ul class="menu">
            ...
            <li> <a href="#"><span class="material-symbols-outlined">person_add</span>CREAR NUEVO ADMIN</a></li>

            <li><a href="#">  <span class="material-symbols-outlined">inventory</span>FORMULARIO</a></li>
...
desktop_access_disabled
            ...
            <ul class="submenu">
            <li><a href="#">ABMINISTRAR BASE DATOS</a></li>
            <li><a href="#">BUSCAR INVENTARIO</a></li>
            ...
            <li><a href="#"> <span class="material-symbols-outlined">do_not_disturb_on</span>CERRAR SESSION</a></li>
